...
# 🍓 Installation des outils WiFi pour Raspberry Pi
...
test_wifi_scan() {
    ...
    if command -v node &> /dev/null; then
        ...
        node test-wifi-raspberry.js 2>/dev/null || print_warning "Test Node.js échoué"
    else
...
show_final_info() {
    ...
    echo "   - node test-wifi-raspberry.js"
    echo ""
